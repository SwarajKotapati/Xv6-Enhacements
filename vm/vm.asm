...
w_tp(uint64 x)
{
  ...
  34:	200c07b7          	lui	a5,0x200c0
  38:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
  3c:	47bd                	li	a5,15
  3e:	3a079073          	csrw	pmpcfg0,a5
  asm volatile("csrr %0, mstatus" : "=r" (x) );
  42:	300027f3          	csrr	a5,mstatus
  ...
  x &= ~MSTATUS_MPP_MASK;
  46:	7779                	lui	a4,0xffffe
  48:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <ustack+0xfffffffffffed71f>
  4c:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
  4e:	6705                	lui	a4,0x1
  50:	80070713          	addi	a4,a4,-2048 # 800 <process_entry+0x3cc>
  54:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
  56:	30079073          	csrw	mstatus,a5
  asm volatile("csrw satp, %0" : : "r" (x));
  5a:	4781                	li	a5,0
  5c:	18079073          	csrw	satp,a5
...
ramdiskrw(struct buf *b)
{
  ...
  da:	37a50513          	addi	a0,a0,890 # 450 <process_entry+0x1c>
...
void* kalloc(void) {
 ...
 32e:	14650513          	addi	a0,a0,326 # 470 <process_entry+0x3c>
...
void create_process(void) {
 ...
 3f6:	04270713          	addi	a4,a4,66 # 434 <process_entry>
...
void kernel_entry(void) {
  ...
  *(int*)(0x80300000 + 0x4) = 5;
 420:	008037b7          	lui	a5,0x803
 424:	07a2                	slli	a5,a5,0x8
 426:	4715                	li	a4,5
 428:	c3d8                	sw	a4,4(a5)
  create_process();
 42a:	00000097          	auipc	ra,0x0
 42e:	fae080e7          	jalr	-82(ra) # 3d8 <create_process>

  /* Nothing to go back to */
  while (true);
 432:	a001                	j	432 <kernel_entry+0x1a>

0000000000000434 <process_entry>:
