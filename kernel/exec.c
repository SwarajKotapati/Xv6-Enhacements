...
//if ((name[0] == 'i' && name[1] == 'n' && name[2] == 'i' && name[3] == 't' && name[4] == 'c' && name[5] == 'o' && name[6] == 'd' && name[7] == 'e' && //name[8] == '\0') || 
//    (name[0] == 's' && name[1] == 'h' && name[2] == 'c' && name[3] == 'o' && name[4] == 'd' && name[5] == 'e' && name[6] == '\0') ||
...
if(memcmp(path,"/init",5) == 0){
	p->ondemand = false;
}

if(memcmp(path,"sh",2) == 0){
	p->ondemand = false;
}
if(memcmp(path,"test8-cow1",10) == 0){
	p->ondemand = false;
}
if(memcmp(path,"test9-cow2",10) == 0){
	p->ondemand = false;
}
if(memcmp(path,"test10-cow3",10) == 0){
	p->ondemand = false;
}
