...
void setup_recovery_kernel(void) {
	...
	uint64 kernel_load_addr       = find_kernel_load_addr(RECOVERY);
  	...
  	memmove((uchar*)kernel_load_addr, (uchar*)((RECOVERYDISK + 4096)), kernel_binary_size+5000);
...
bool is_secure_boot(void) {
  ...
  sha256_update(&sha256_ctx, (const BYTE *)(0x84000000), (size_t)(kernel_binary_size));
...
void start()
{
  ...
  sys_info_ptr-> bl_end = 0x0000000080080000;
  ...
  memmove((uchar*)kernel_load_addr, (uchar*)((RAMDISK + 4096)), kernel_binary_size+5000);
